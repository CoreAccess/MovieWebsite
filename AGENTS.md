...
* **Safe Markdown Rendering:** *CRITICAL RULE*: All Markdown parsing into HTML must happen securely on the Go backend. The JS frontend acts as a "dumb renderer" and is strictly forbidden from parsing Markdown to prevent XSS. Formatted reviews/content are delivered as pre-rendered HTML partials.
