...
func (m *SqliteDBRepo) SearchMedia(query string, limit, offset int) ([]models.Media, error) {
	return nil, nil
}
func (m *SqliteDBRepo) GetMediaByID(id int) (*models.Media, error) { return nil, nil }
func (m *SqliteDBRepo) GetAllMovies(limit int, offset int, sort string) ([]models.Movie, error) {
	return nil, nil
}
...
func (m *SqliteDBRepo) GetAllShows(limit int, offset int, sort string) ([]models.TVSeries, error) {
	return nil, nil
}
...
func (m *SqliteDBRepo) GetAllPeople(limit int, offset int, sort string) ([]models.Person, error) {
	return nil, nil
}
func (m *SqliteDBRepo) GetPersonByID(id int) (*models.Person, error) { return nil, nil }
func (m *SqliteDBRepo) SearchMovies(searchQuery string, limit int, offset int) ([]models.Movie, error) {
	return nil, nil
}
func (m *SqliteDBRepo) SearchShows(searchQuery string, limit int, offset int) ([]models.TVSeries, error) {
	return nil, nil
}
func (m *SqliteDBRepo) SearchPeople(searchQuery string, limit int, offset int) ([]models.Person, error) {
	return nil, nil
}
...
func (m *SqliteDBRepo) InsertMediaCast(mediaID int, personID int, character string, order int) error {
	return nil
}
